package com.residencia.biblioteca.security;
...
import com.residencia.biblioteca.security.service.UserDetailsServiceImpl;

@Configuration /*para configurar a segurança*/
...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		//filterChain aplica todas as configurações necessárias para alteração na segurança
		// perfil e role sao a mesma coisa
		//auth tudo que esta dentro de auth e liberado para acesso geral
